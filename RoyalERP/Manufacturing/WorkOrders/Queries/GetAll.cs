...
public class GetAll {
    ...
    public class Handler : IRequestHandler<Query, IActionResult> {
        ...
        public async Task<IActionResult> Handle(Query request, CancellationToken cancellationToken) {
            ...
            const string query = "SELECT id, version, salesorderid, number, name, note, customername, vendorname, releaseddate, scheduleddate, fulfilleddate, status FROM manufacturing.workorders;";
