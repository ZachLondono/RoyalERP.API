...
public class WorkOrderTests {
    ...
    public void Create_Should_InitilizeWorkOrder() {
        ...
        // Act
        var order = WorkOrder.Create(salesOrderId, number, name, Guid.NewGuid(), 0, customername, vendorname);
    ...
    public void Release_Should_UpdateState_And_CreateEvent() {
        ...
        string customername = "Company A";
        string vendorname = "Company B";
        var order = new WorkOrder(Guid.NewGuid(), 0, salesOrderId, number, name, "", Guid.NewGuid(), 0, customername, vendorname, WorkOrderStatus.Pending, null, null, null);
    ...
    public void Schedule_Should_UpdateState_And_CreateEvent() {
        ...
        string customername = "Company A";
        string vendorname = "Company B";
        var order = new WorkOrder(Guid.NewGuid(), 0, salesOrderId, number, name, "", Guid.NewGuid(), 0, customername, vendorname, WorkOrderStatus.InProgress, null, null, null);
    ...
    public void Fulfill_Should_UpdateState_And_CreateEvent() {
        ...
        string customername = "Company A";
        string vendorname = "Company B";
        var order = new WorkOrder(Guid.NewGuid(), 0, salesOrderId, number, name, "", Guid.NewGuid(), 0, customername, vendorname, WorkOrderStatus.InProgress, DateTime.Today, null, null);
    ...
    public void Release_Should_ThrowException_WhenCancled() {
        ...
        string customername = "Company A";
        string vendorname = "Company B";
        var order = new WorkOrder(Guid.NewGuid(), 0, salesOrderId, number, name, "", Guid.NewGuid(), 0, customername, vendorname, WorkOrderStatus.Cancelled, null, null, null);
    ...
    public void SetNote_ShouldUpdateNote_AndAddEvent() {
        ...
        // Arrange
        var order = new WorkOrder(Guid.NewGuid(), 0, Guid.NewGuid(), "", "", "", Guid.NewGuid(), 0, "", "", WorkOrderStatus.Cancelled, null, null, null);
